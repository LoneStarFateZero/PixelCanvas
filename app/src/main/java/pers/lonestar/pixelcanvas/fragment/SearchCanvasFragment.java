...
import pers.lonestar.pixelcanvas.adapter.SearchCanvasAdapter;
...
public class SearchCanvasFragment extends Fragment {
    ...
    public void setQueryCanvasName(String canvasName) {
    ...
    private void initView() {
        ...
        //设置网格布局管理器
        GridLayoutManager gridLayoutManager = new GridLayoutManager(SearchActivity.getInstance(), 2);
        ...
        //设置适配器
        adapter = new SearchCanvasAdapter(bmobCanvasList);
    ...
    private void refreshData() {
        ...
        loadMoreQuery.addWhereEqualTo("canvasName", canvasName);
        //小于当前时间
